				...
				<ul>
					<li className={props.selectedDemo === "resizable" ? "active" : undefined}>
						<a onClick={() => props.setSelectedDemo("resizable")}>
							...
							<span>Example with nested and resizable spaces</span>
						</a>
					</li>
